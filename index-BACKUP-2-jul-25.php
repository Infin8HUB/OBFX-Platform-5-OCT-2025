                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="heading-title">
                            <h3 class="title iq-tw-5 iq-mb-20">About <b>OBFX</b></h3>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="heading-title iq-mb-0">
                            <h3 class="title iq-tw-5 iq-mb-20">3 Easy Steps how to earn money with OBFX</h3>
                    ...
                    <div class="col-lg-4 col-md-12">
                        <div class="iq-feature3 iq-bg iq-mt-20">
                            ...
                            <div class="fancy-content">
                                ...
                                <p>Sign up on the OBFX platform to get started.</p>
            ...
            <div class="container">
                <div class="row h-100">
                    ...
                    <div class="col-lg-6 col-md-12 iq-mb-80 offset-xl-2">
                        <h2 class="iq-font-white iq-tw-6"><span class="iq-font-yellow">OBFX</span></h2>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 iq-contact iq-r4-mt-40">
                        <div class="heading-left">
                            <h5 class="title iq-tw-5 iq-font-white">Contact OBFX</h5></div>
                        <!-- <div class="iq-mb-20">
                        ...
                        <div class="iq-mb-20">
                            <div class="blog "><i class="ion-ios-email-outline"></i>
                                <div class="content">
                                    <div class="iq-tw-6 title ">Mail</div> support@obfx.net</div>
                            </div>
                        </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-12 text-center">
                        <div class="iq-copyright iq-mt-10 iq-font-white">Copyright <span id="copyright"> <script>document.getElementById('copyright').appendChild(document.createTextNode(new Date().getFullYear()))</script></span> <a href="#home"><b>OBFX</b></a> All Rights Reserved </div>
                    </div>
                </div>
            </div>
        </div>
