...
<head>
    <title>Infin8FX - Trading Platform</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
...
<body>
                    ...
                    <div class="col-md-12">
                        ...
                        <nav> <a id="resp-menu" class="responsive-menu" href="javascript:void(0)"><i class="fa fa-reorder"></i> Menu</a>
                            <ul class="menu text-right">
								...
								<li><a href="login.php"><b><font color=#FFFFFF>Login</font></b></a>
								</li>
								<li>
    ...
    <div id="rev_slider_4_1_wrapper" class="rev_slider_wrapper fullwidthbanner-container" data-alias="coinexhd" data-source="gallery" style="margin:0px auto;background:transparent;padding:0px;margin-top:0px;margin-bottom:0px;">
        ...
        <div id="rev_slider_4_1" class="rev_slider fullwidthabanner tp-overflow-hidden" data-version="5.4.6.3">
            <ul>
                <!-- SLIDE  -->
...
<video autoplay muted style="width:100%; height:100%; object-fit:cover;">
 ...
 <div class="tp-caption tp-resizeme"
     ...
     data-frames='[{"delay":500,"speed":1500,"frame":"0","from":"y:[-100%];opacity:0;","to":"o:1;","ease":"Power3.easeInOut"}]'
     style="z-index: 10; white-space: nowrap; font-size: 65px; line-height: 70px; font-weight: 700; color: #ffffff; font-family: 'Ubuntu', sans-serif;">

  <span style="color: #ffffff;">Infin</span><span style="color: #00897B;">8</span><span style="color: #D32F2F;">F</span><span style="color: #333333;">X</span><br>

  <span style="display: block; font-size: 40px; font-weight: 400; color: #ffffff;">Your Gateway to the Future of Trading</span>
  <span style="display: block; font-size: 35px; font-weight: 300; color: #ffffff;">Where Limits Don’t Exist.</span>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="heading-title">
                            <h3 class="title iq-tw-5 iq-mb-20">About <b>Infin<span style="color:#45877b;">8</span><span style="color:#bc4038;">F</span><span style="color:#343331;">X</span></b>
</h3>
...
<span class="icon">
  <img src="images/logo.png" alt="Infin8FX Logo" style="width:40px; height:auto;">
</span>
...
<span class="icon">
  <img src="images/logo.png" alt="Infin8FX Logo" style="width:40px; height:auto;">
        ...
        <section class="overview-block-pt iq-about1 iq-bg iq-over-black-80 jarallax" style="background-image: url('images/bg/bg-5.jpg'); background-position: left center;">
            <div class="container">
                <div class="row h-100">
<img class="img-fluid iq-img" src="images/figure8.png" alt="Figure 8 Logo" style="position:absolute; left:-5%; bottom:-20%; width:40%; max-width:1000px; height:auto; z-index:0;">

                    <div class="col-lg-6 col-md-12 iq-mb-80 offset-xl-2">
   

                       <h2 class="iq-font-white iq-tw-6">
  Infin<span style="color:#45877b;">8</span><span style="color:#bc4038;">F</span><span style="color:#343331;">X</span>
</h2>
        ...
        <!-- <section class="overview-block-ptb iq-feature4 iq-additional" id="recovery">
            <div class="container">
                <div class="row">
                    <div class="col-sm-12">
                        <div class="heading-title">
                            <h3 class="title iq-tw-5 iq-mb-20">Recovery In Infin8FX</h3>
                        </div>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 iq-contact iq-r4-mt-40">
                        ...
                        <div class="iq-mb-20">
                            <div class="blog "><i class="ion-ios-email-outline"></i>
                                <div class="content">
                                    <div class="iq-tw-6 title ">Mail</div> info@infin8fx.com</div>
                            </div>
                        </div>
                        ...
                        <div class="blog">
                            ...
                            Address:5 Newton Lane, Old Windsor, Windsor, Berkshire, England, SL4 2RY .
                            </div> 
                        </div>
                    </div>
