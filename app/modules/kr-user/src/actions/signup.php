...
try {
    ...
    // Check post given
    $fieldNeeded = ['kr_usr_name', 'kr_usr_email', 'kr_usr_pwd', 'kr_usr_rep_pwd', 'kr_usr_agree', 'kr_usr_country','kr_usr_phone_number'];
    $fieldMissing = [];
    ...
    if(!preg_match('/^[0-9]{7,13}+$/', $_POST['kr_usr_phone_number'])) die(json_encode(['error' => 2, 'fields' => ['kr_usr_phone_number' => $Lang->tr('Phone number not valid')]]));
    
    // Create user
    $User->_createUser($_POST['kr_usr_email'], $_POST['kr_usr_name'], $_POST['kr_usr_pwd'], $_POST['kr_usr_phone_number'], $_POST['kr_usr_country']);
