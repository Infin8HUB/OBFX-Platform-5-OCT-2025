  ...
  <section>
    ...
    <div>
      ...
      <ul>
        ...
        <?php endif; ?>
        <?php if(!is_null($App->_getTelegramLink()) && strlen($App->_getTelegramLink()) > 1): ?>
          <li>
            <span><?php echo $Lang->tr('Telegram'); ?></span>
            <span><a href="<?php echo $App->_getTelegramLink(); ?>" target="_blank"><?php echo $App->_getTelegramLink(); ?></a></span>
          </li>
        <?php endif; ?>
      </ul>
    </div>
