...
class App extends MySQL {
  ...
  public function _loadMainController(){
      $this->mainControllerList = [
          'App' => $_SERVER['DOCUMENT_ROOT'] . FILE_PATH . "/app/src/App/App.php",
          'AppModule' => $_SERVER['DOCUMENT_ROOT'] . FILE_PATH . "/app/src/App/AppModule.php",
          'CryptoApi' => $_SERVER['DOCUMENT_ROOT'] . FILE_PATH . "/app/src/CryptoApi/CryptoApi.php",
          'CryptoCoin' => $_SERVER['DOCUMENT_ROOT'] . FILE_PATH . "/app/src/CryptoApi/CryptoCoin.php",
          'CryptoGraph' => $_SERVER['DOCUMENT_ROOT'] . FILE_PATH . "/app/src/CryptoApi/CryptoGraph.php",
          'CryptoHisto' => $_SERVER['DOCUMENT_ROOT'] . FILE_PATH . "/app/src/CryptoApi/CryptoHisto.php",
          'CryptoIndicators' => $_SERVER['DOCUMENT_ROOT'] . FILE_PATH . "/app/src/CryptoApi/CryptoIndicators.php",
          'CryptoNotification' => $_SERVER['DOCUMENT_ROOT'] . FILE_PATH . "/app/src/CryptoApi/CryptoNotification.php",
          'CryptoOrder' => $_SERVER['DOCUMENT_ROOT'] . FILE_PATH . "/app/src/CryptoApi/CryptoOrder.php",
          'Lang' => $_SERVER['DOCUMENT_ROOT'] . FILE_PATH . "/app/src/Lang/Lang.php",
          'MySQL' => $_SERVER['DOCUMENT_ROOT'] . FILE_PATH . "/app/src/MySQL/MySQL.php",
          'User' => $_SERVER['DOCUMENT_ROOT'] . FILE_PATH . "/app/src/User/User.php",
          // 'LeadsApi' => $_SERVER['DOCUMENT_ROOT'] . FILE_PATH . "/app/src/Leads8Api/LeadsApi.php",
      ];
  }
  ...
  public static function _getVersion(){ return base64_encode("5.2.4"); }
  ...
  public function _loadModules(){
    ...
    foreach (scandir($_SERVER['DOCUMENT_ROOT'].FILE_PATH.'/app/modules') as $directory) {
      ...
      if($directory == 'kr-chat' && $this->_chatIsDisabled()){
          continue;
      }
  ...
  public function _loadModulesControllers(){
    ...
    if(!empty($this->mainControllerList)){
        foreach ($this->mainControllerList as $className => $classUrl){
   ...
   * @return Boolean
   */
  public function _isBtcnetBlocked(){ return $this->_getSettingsAttribute('btcnet_block') == 1; }
  ...
  public function _getTelegramLink(){ return $this->_getSettingsAttribute('telegram_link'); }
   ...
   */
  public function _saveSupport($email, $phone, $address, $dpoemail, $dpophone, $telegramLink){
    ...
    $this->_saveSettingsAttribute('telegram_link', $telegramLink);
  }
  ...
  public function _saveGeneralsettings($apptitle, $appdescription, $enablesignup, $recaptcha_enabled, $gogglesitekey,
                                      ...
                                      $disable_chat, $startingpar, $watchinglistpair, $rewritedashboard, $btcnetBlock){
    ...
    $this->_saveSettingsAttribute('btcnet_block', $btcnetBlock);
  }
